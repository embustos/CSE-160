class Cone {
    ...
    _buildVBO(n) {
        ...
        for (var i = 0; i < n; i++) {
            ...
            buf.push(x1,y1,1,  x2,y2,1,  cx,cy,0);
            buf.push(cx,cy,1,  x2,y2,1,  x1,y1,1);
        }

        this._sidesCount = n * 3;          
        this._totalCount = n * 6;            
    ...
    render() {
        ...
        gl.drawArrays(gl.TRIANGLES, this._sidesCount, this._sidesCount);
    }
}
